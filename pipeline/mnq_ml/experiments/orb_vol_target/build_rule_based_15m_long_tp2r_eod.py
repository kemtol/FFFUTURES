...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sweep-dir", default="data/Level_2_Datamart/mnq/orb_vol_target/sweeps")
    parser.add_argument(
        "--output-dir",
        default="data/Level_2_Datamart/mnq/orb_vol_target/rule_based_15m_long_tp2r_eod",
    )
...
def main() -> int:
    ...
    manifest = {
        ...
        "config": "pipeline/mnq_ml/experiments/orb_vol_target/config.json",
        "filter": {
            "orb_minutes": 15,
            "side_mode": "long",
