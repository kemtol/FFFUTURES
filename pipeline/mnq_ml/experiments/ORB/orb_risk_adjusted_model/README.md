...
```text
data/Level_2_Datamart/mnq/ORB/orb_risk_adjusted_model/daily_scenarios.parquet
data/Level_2_Datamart/mnq/ORB/orb_risk_adjusted_model/daily_scenarios_manifest.json
```
...
python3 pipeline/mnq_ml/experiments/ORB/orb_risk_adjusted_model/audit_daily_scenarios.py
...
python3 pipeline/mnq_ml/experiments/ORB/orb_risk_adjusted_model/build_breakout_quality_features.py --force
python3 pipeline/mnq_ml/experiments/ORB/orb_risk_adjusted_model/audit_breakout_quality_features.py
python3 pipeline/mnq_ml/experiments/ORB/orb_risk_adjusted_model/train_risk_adjusted_v1.py --force
python3 pipeline/mnq_ml/experiments/ORB/orb_risk_adjusted_model/simulate_kelly_overlay.py --force
...
```text
data/Level_2_Datamart/mnq/ORB/orb_risk_adjusted_model/daily_scenarios_audit.json
```
...
data/Level_2_Datamart/mnq/ORB/orb_risk_adjusted_model/breakout_quality_features_manifest.json
data/Level_2_Datamart/mnq/ORB/orb_risk_adjusted_model/breakout_quality_features_audit.json
```
...
```text
model/MNQ/ORB/orb_risk_adjusted_model/risk_adjusted_v1_metrics.json
model/MNQ/ORB/orb_risk_adjusted_model/risk_adjusted_v1_report.md
model/MNQ/ORB/orb_risk_adjusted_model/risk_adjusted_v1_feature_importance.csv
model/MNQ/ORB/orb_risk_adjusted_model/risk_adjusted_v1_*_*.joblib
```
...
model/MNQ/ORB/orb_risk_adjusted_model/risk_adjusted_v2_feature_importance.csv
