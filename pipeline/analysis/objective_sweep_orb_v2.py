"""
Objective Sweep v2 — retrain with extended data (2010-2023) to address 2026 OOD failure.

Key changes from v1:
  - Training: 2010-2023 (was 2010-2021) — includes 2022-2023 moderate ADX regime
  - Validation/Calibration: 2024 (was 2022-2023) — beginning of volatility increase
  - Holdout: 2025-2026 (was 2024+) — tests on the actual crisis period
  - Everything else identical to v1 for fair comparison

Output: model/SWEEP_v2/
...
OUT_DIR = ROOT / "model/SWEEP_v2"

# v2: extended training, delayed holdout
...
def main() -> None:
    ...
    for target, rr in LABELS:
        ...
        print(f"  Training rev model (train<={TRAIN_TO}, val={CALIB_FROM}..{CALIB_TO})...",
              end=" ", flush=True)
...
def write_report(df: pd.DataFrame) -> None:
    ...
    report = f"""# Objective Sweep Report v2 — ORB (Extended Training)
